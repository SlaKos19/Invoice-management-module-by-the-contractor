...
<div class="text-center">
  ...
  <tbody .table-hover>
        @foreach ($contractor->invoices as $invoice)
  <tr>
      <th scope="row">{{ $invoice->id }}</th>
      <td>{{ $invoice->company }}</td>
      <td>{{ $invoice->date }}</td>
      <td>{{ $invoice->total }}</td>
      <td><a href="{{ route('invoices.edit_invoices' , ['id' => $invoice->id]) }}" class="btn btn-primary">Edytuj </a></td>
      <td><form method="POST" action="{{ route('invoices.delete' , ['id' => $invoice->id]) }}">
        @csrf
        @method('delete')
